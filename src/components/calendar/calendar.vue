...
const eventResizeStartRowIndex=ref<[number,number,number]>()
const eventResizeStartY=ref<number>()
const eventResizeEndDate=ref<IClient_Calendar_Date>()
const eventResizeStartDate=ref<IClient_Calendar_Date>()
const eventActionEvent=ref<IClient_Calendar_Info>()
